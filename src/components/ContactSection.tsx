    ...
    <section id="contact" className="section-dark-alt py-28 md:py-36">
      <div className="max-w-[980px] mx-auto px-6 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="mailto:dev.cenkcetin@gmail.com" className="bg-apple-blue hover:bg-apple-blue/90 text-[#f5f5f7] text-base font-medium px-8 py-3.5 rounded-pill transition-all duration-300 hover:shadow-[0_4px_20px_rgba(0,113,227,0.4)]">
            dev.cenkcetin@gmail.com
          </a>
          <a href="tel:+905525927390" className="bg-[#f5f5f7]/10 hover:bg-[#f5f5f7]/15 text-[#f5f5f7] text-base font-medium px-8 py-3.5 rounded-pill transition-all duration-300 border border-[#f5f5f7]/[0.06]">
            +90 552 592 73 90
          </a>
        </motion.div>
